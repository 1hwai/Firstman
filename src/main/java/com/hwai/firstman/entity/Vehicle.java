package com.hwai.firstman.entity;//package com.hwai.firstman.entity;
//
...
//
//    protected static final EntityDataAccessor<Float> VELOCITY = SynchedEntityData.defineId(Vehicle.class, EntityDataSerializers.FLOAT);
...
//        this.entityData.set(VELOCITY, value);
//    }
//
//    @Override
...
//            this.level().addFreshEntity(new ItemEntity(this.level(), pos.getX(), pos.getY() + 0.5f, pos.getZ(), ItemStack.EMPTY));
//        }
//
